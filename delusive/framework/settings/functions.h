...
public:
    ...
    std::vector<keybind_reg_t> registered_keybinds;
    ...
    bool label_keybind(const char* label, int* key, int* mode, const char* bind_name = nullptr);
...
inline bool g_is_reloading = false;
inline float g_reload_progress = 0.0f;
inline bool g_is_on_server = false;
