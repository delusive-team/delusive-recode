...
namespace sdk {
	...
	public:
		static void initialize() {
			il2cpp_field_offset(light_intensity_ptr, _(""), _("TOD_NightParameters"), _("LightIntensity"));
			il2cpp_field_offset(ambient_multiplier_ptr, _(""), _("TOD_NightParameters"), _("AmbientMultiplier"));
			il2cpp_field_offset(reflection_multiplier_ptr, _(""), _("TOD_NightParameters"), _("ReflectionMultiplier"));
			il2cpp_field_offset(shadow_strength_ptr, _(""), _("TOD_NightParameters"), _("ShadowStrength"));
		}
