...
namespace memory
{
    ...
    struct address_t
    {
        ...
        __forceinline address_t< T >( )
        {
            m_ptr = (T*)0;
        }

        __forceinline address_t< T >( T* ptr )
        {
            m_ptr = ptr;
        }

        __forceinline address_t< T >( uintptr_t va )
        {
            m_ptr = (T*)( va );
        }
        ...
        __forceinline address_t< T > add( uint64_t offset )
        {
            return address_t< T >( (T*)( (uintptr_t)m_ptr + offset ) );
        }
        ...
        __forceinline T& operator[]( uint64_t index )
        {
            return m_ptr[ index ];
        }

        __forceinline bool operator==( T* val )
        {
            return m_ptr == val;
        }

        __forceinline bool operator==( uintptr_t val )
        {
            return reinterpret_cast<uintptr_t>( m_ptr ) == val;
        }
        ...
        __forceinline auto operator+( uint32_t val )
        {
            return add( val );
        }
    };
