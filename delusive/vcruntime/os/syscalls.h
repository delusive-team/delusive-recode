...
inline std::unordered_map<hash_t, uint32_t> sys_calls = {};
...
#define IMPORT_SYSTEM_CALL(SYSTEM_CALL_TYPE, SYSTEM_CALL_NAME, SYSTEM_CALL_PARAMS, ...) \
  ...
  inline SYSTEM_CALL_TYPE SYSTEM_CALL_NAME##SYSTEM_CALL_PARAMS {                          \
    const auto& system_call_number = sys_calls.contains(HASH(#SYSTEM_CALL_NAME)) ?       \
                                     sys_calls[HASH(#SYSTEM_CALL_NAME)] :                \
                                     (sys_calls[HASH(#SYSTEM_CALL_NAME)] =              \
                                       safe.get_system_index(HASH(#SYSTEM_CALL_NAME))); \
                                                                                          \
